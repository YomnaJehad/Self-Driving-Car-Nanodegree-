...
{\color{incolor}In [{\color{incolor}30}]:} \PY{c+c1}{\PYZsh{}importing some useful packages}
...
\subsection{Read in an Image}\label{read-in-an-image}}
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}31}]:} \PY{c+c1}{\PYZsh{}reading in an image}
...
\begin{Verbatim}[commandchars=\\\{\}]
{\color{outcolor}Out[{\color{outcolor}31}]:} <matplotlib.image.AxesImage at 0x7efda67ee908>
\end{Verbatim}
...
{\color{incolor}In [{\color{incolor}32}]:} \PY{k+kn}{import} \PY{n+nn}{math}
         ...
         \PY{l+s+sd}{    \PYZdq{}\PYZdq{}\PYZdq{}}
             ...
             \PY{n}{lowerLeft}\PY{o}{=}\PY{p}{(}\PY{l+m+mi}{0}\PY{p}{,}\PY{l+m+mi}{0}\PY{p}{)}
             \PY{n}{lowerRight}\PY{o}{=}\PY{p}{(}\PY{l+m+mi}{0}\PY{p}{,}\PY{l+m+mi}{0}\PY{p}{)}
             \PY{n}{upperLeft}\PY{o}{=}\PY{p}{(}\PY{l+m+mi}{0}\PY{p}{,}\PY{l+m+mi}{0}\PY{p}{)}
             \PY{n}{upperRight}\PY{o}{=}\PY{p}{(}\PY{l+m+mi}{0}\PY{p}{,}\PY{l+m+mi}{0}\PY{p}{)}
             \PY{n}{slopeRight}\PY{o}{=}\PY{l+m+mi}{0}
             \PY{n}{slopeLeft}\PY{o}{=}\PY{l+m+mi}{0}
             \PY{n}{slopesLeft}\PY{o}{=}\PY{p}{[}\PY{p}{]}
             \PY{n}{slopesRight}\PY{o}{=}\PY{p}{[}\PY{p}{]}
             \PY{n}{cLeft}\PY{o}{=}\PY{p}{[}\PY{p}{]}
             \PY{n}{cRight}\PY{o}{=}\PY{p}{[}\PY{p}{]}
             \PY{k}{for} \PY{n}{line} \PY{o+ow}{in} \PY{n}{lines}\PY{p}{:}
                 \PY{k}{for} \PY{n}{x1}\PY{p}{,}\PY{n}{y1}\PY{p}{,}\PY{n}{x2}\PY{p}{,}\PY{n}{y2} \PY{o+ow}{in} \PY{n}{line}\PY{p}{:}
                     \PY{k}{try}\PY{p}{:}
                         \PY{n}{m}\PY{o}{=}\PY{p}{(}\PY{n}{y2}\PY{o}{\PYZhy{}}\PY{n}{y1}\PY{p}{)}\PY{o}{/}\PY{p}{(}\PY{n}{x2}\PY{o}{\PYZhy{}}\PY{n}{x1}\PY{p}{)}
                     \PY{k}{except}\PY{p}{:}
                         \PY{n}{m}\PY{o}{=}\PY{l+m+mi}{55}
                     \PY{k}{if} \PY{n}{m}\PY{o}{\PYZgt{}}\PY{l+m+mi}{0} \PY{p}{:}
                         \PY{n}{slopesLeft}\PY{o}{.}\PY{n}{append}\PY{p}{(}\PY{n}{m}\PY{p}{)}
                         \PY{n}{cLeft}\PY{o}{.}\PY{n}{append}\PY{p}{(}\PY{n}{y1}\PY{o}{\PYZhy{}}\PY{n}{m}\PY{o}{*}\PY{n}{x1}\PY{p}{)}
                     \PY{k}{if} \PY{n}{m}\PY{o}{\PYZlt{}}\PY{l+m+mi}{0} \PY{p}{:}
                         \PY{n}{slopesRight}\PY{o}{.}\PY{n}{append}\PY{p}{(}\PY{n}{m}\PY{p}{)}
                         \PY{n}{cRight}\PY{o}{.}\PY{n}{append}\PY{p}{(}\PY{n}{y1}\PY{o}{\PYZhy{}}\PY{n}{m}\PY{o}{*}\PY{n}{x1}\PY{p}{)}
                     
                     
             \PY{n}{slopeLeftAvg}\PY{o}{=}\PY{n}{np}\PY{o}{.}\PY{n}{median}\PY{p}{(}\PY{n}{slopesLeft}\PY{p}{)}
             \PY{n}{cLeftAvg}\PY{o}{=}\PY{n}{np}\PY{o}{.}\PY{n}{median}\PY{p}{(}\PY{n}{cLeft}\PY{p}{)}
             
             \PY{n}{lowerLeft}\PY{o}{=}\PY{p}{(}\PY{p}{(}\PY{p}{(}\PY{p}{(}\PY{n}{imshape}\PY{p}{[}\PY{l+m+mi}{0}\PY{p}{]}\PY{o}{\PYZhy{}}\PY{n}{cLeftAvg}\PY{p}{)}\PY{o}{/}\PY{p}{(}\PY{n}{slopeLeftAvg}\PY{p}{)}\PY{p}{)} \PY{k}{if} \PY{n}{slopeLeftAvg}\PY{o}{!=}\PY{l+m+mi}{0} \PY{k}{else} \PY{l+m+mi}{0}\PY{p}{)}\PY{p}{,}\PY{n}{imshape}\PY{p}{[}\PY{l+m+mi}{0}\PY{p}{]}\PY{p}{)}
             \PY{n}{upperLeft}\PY{o}{=}\PY{p}{(}\PY{p}{(}\PY{p}{(}\PY{p}{(}\PY{l+m+mi}{320}\PY{o}{\PYZhy{}}\PY{n}{cLeftAvg}\PY{p}{)}\PY{o}{/}\PY{p}{(}\PY{n}{slopeLeftAvg}\PY{p}{)}\PY{p}{)} \PY{k}{if} \PY{n}{slopeLeftAvg}\PY{o}{!=}\PY{l+m+mi}{0} \PY{k}{else} \PY{l+m+mi}{0}\PY{p}{)}\PY{p}{,}\PY{l+m+mi}{320}\PY{p}{)}
             
             \PY{n}{slopeRightAvg}\PY{o}{=}\PY{n}{np}\PY{o}{.}\PY{n}{median}\PY{p}{(}\PY{n}{slopesRight}\PY{p}{)}
             \PY{n}{cRightAvg}\PY{o}{=}\PY{n}{np}\PY{o}{.}\PY{n}{median}\PY{p}{(}\PY{n}{cRight}\PY{p}{)}
             
             \PY{n}{lowerRight}\PY{o}{=}\PY{p}{(}\PY{p}{(}\PY{p}{(}\PY{p}{(}\PY{n}{imshape}\PY{p}{[}\PY{l+m+mi}{0}\PY{p}{]}\PY{o}{\PYZhy{}}\PY{n}{cLeftAvg}\PY{p}{)}\PY{o}{/}\PY{p}{(}\PY{n}{slopeLeftAvg}\PY{p}{)}\PY{p}{)} \PY{k}{if} \PY{n}{slopeLeftAvg}\PY{o}{!=}\PY{l+m+mi}{0} \PY{k}{else} \PY{n}{imshape}\PY{p}{[}\PY{l+m+mi}{0}\PY{p}{]}  \PY{p}{)}\PY{p}{,}\PY{n}{imshape}\PY{p}{[}\PY{l+m+mi}{0}\PY{p}{]}\PY{p}{)}
             \PY{n}{upperRight}\PY{o}{=}\PY{p}{(}\PY{p}{(}\PY{p}{(}\PY{p}{(}\PY{l+m+mi}{320}\PY{o}{\PYZhy{}}\PY{n}{cRightAvg}\PY{p}{)}\PY{o}{/}\PY{p}{(}\PY{n}{slopeRightAvg}\PY{p}{)}\PY{p}{)} \PY{k}{if} \PY{n}{slopeRightAvg}\PY{o}{!=}\PY{l+m+mi}{0} \PY{k}{else} \PY{n}{imshape}\PY{p}{[}\PY{l+m+mi}{0}\PY{p}{]} \PY{p}{)}\PY{p}{,}\PY{l+m+mi}{320}\PY{p}{)}
             
             \PY{n}{cv2}\PY{o}{.}\PY{n}{line}\PY{p}{(}\PY{n}{line\PYZus{}img}\PY{p}{,}\PY{p}{(}\PY{n+nb}{int}\PY{p}{(}\PY{p}{(}\PY{n}{imshape}\PY{p}{[}\PY{l+m+mi}{0}\PY{p}{]}\PY{o}{\PYZhy{}}\PY{n}{cLeftAvg}\PY{p}{)}\PY{o}{/}\PY{n}{slopeLeftAvg}\PY{p}{)}\PY{p}{,}\PY{n+nb}{int}\PY{p}{(}\PY{n}{imshape}\PY{p}{[}\PY{l+m+mi}{0}\PY{p}{]}\PY{p}{)}\PY{p}{)} \PY{p}{,} \PY{p}{(}\PY{n+nb}{int}\PY{p}{(}\PY{p}{(}\PY{l+m+mi}{320}\PY{o}{\PYZhy{}}\PY{n}{cLeftAvg}\PY{p}{)}\PY{o}{/}\PY{n}{slopeLeftAvg}\PY{p}{)}\PY{p}{,}\PY{n+nb}{int}\PY{p}{(}\PY{l+m+mi}{320}\PY{p}{)}\PY{p}{)}\PY{p}{,} \PY{p}{[}\PY{l+m+mi}{255}\PY{p}{,} \PY{l+m+mi}{0}\PY{p}{,} \PY{l+m+mi}{0}\PY{p}{]}\PY{p}{,}\PY{l+m+mi}{10}\PY{p}{)}
             \PY{k}{try}\PY{p}{:}
                 \PY{n}{cv2}\PY{o}{.}\PY{n}{line}\PY{p}{(}\PY{n}{line\PYZus{}img}\PY{p}{,}\PY{p}{(}\PY{n+nb}{int}\PY{p}{(}\PY{p}{(}\PY{n}{imshape}\PY{p}{[}\PY{l+m+mi}{0}\PY{p}{]}\PY{o}{\PYZhy{}}\PY{n}{cRightAvg}\PY{p}{)}\PY{o}{/}\PY{n}{slopeRightAvg}\PY{p}{)}\PY{p}{,}\PY{n+nb}{int}\PY{p}{(}\PY{n}{imshape}\PY{p}{[}\PY{l+m+mi}{0}\PY{p}{]}\PY{p}{)}\PY{p}{)} \PY{p}{,} \PY{p}{(}\PY{n+nb}{int}\PY{p}{(}\PY{p}{(}\PY{l+m+mi}{320}\PY{o}{\PYZhy{}}\PY{n}{cRightAvg}\PY{p}{)}\PY{o}{/}\PY{p}{(}\PY{n}{slopeRightAvg}\PY{o}{\PYZhy{}}\PY{o}{.}\PY{l+m+mi}{01}\PY{p}{)}\PY{p}{)}\PY{p}{,}\PY{n+nb}{int}\PY{p}{(}\PY{l+m+mi}{320}\PY{p}{)}\PY{p}{)}\PY{p}{,} \PY{p}{[}\PY{l+m+mi}{255}\PY{p}{,} \PY{l+m+mi}{0}\PY{p}{,} \PY{l+m+mi}{0}\PY{p}{]}\PY{p}{,}\PY{l+m+mi}{10}\PY{p}{)}
             \PY{k}{except}\PY{p}{:}
                 \PY{k}{pass}
           
             \PY{l+s+sd}{\PYZdq{}\PYZdq{}\PYZdq{}\PYZdq{}}
         \PY{l+s+sd}{    print(slopesLeft)}
         \PY{l+s+sd}{    print(cLeft)}
         \PY{l+s+sd}{    print(slopeLeftAvg)}
         \PY{l+s+sd}{    print(cLeftAvg)}
         \PY{l+s+sd}{    \PYZdq{}\PYZdq{}\PYZdq{}}
...
before you try the videos.}
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}33}]:} \PY{k+kn}{import} \PY{n+nn}{os}
         \PY{n}{os}\PY{o}{.}\PY{n}{listdir}\PY{p}{(}\PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{test\PYZus{}images/}\PY{l+s+s2}{\PYZdq{}}\PY{p}{)}
\end{Verbatim}


\begin{Verbatim}[commandchars=\\\{\}]
{\color{outcolor}Out[{\color{outcolor}33}]:} ['whiteCarLaneSwitch.jpg',
          'solidYellowLeft.jpg',
...
thresholds as well as the Hough lines parameters.
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}34}]:} \PY{c+c1}{\PYZsh{} TODO: Build your pipeline that will draw lane lines on the test\PYZus{}images}
         \PY{c+c1}{\PYZsh{} then save them to the test\PYZus{}images\PYZus{}output directory.}
         
         \PY{c+c1}{\PYZsh{}Getting all the images }
         \PY{n}{whiteCarLaneSwitchImage}\PY{o}{=}\PY{n}{mpimg}\PY{o}{.}\PY{n}{imread}\PY{p}{(}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{test\PYZus{}images/whiteCarLaneSwitch.jpg}\PY{l+s+s1}{\PYZsq{}}\PY{p}{)}
         \PY{n}{solidYellowLeftImage}\PY{o}{=}\PY{n}{mpimg}\PY{o}{.}\PY{n}{imread}\PY{p}{(}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{test\PYZus{}images/solidYellowLeft.jpg}\PY{l+s+s1}{\PYZsq{}}\PY{p}{)}
         \PY{n}{solidYellowCurve2Image}\PY{o}{=}\PY{n}{mpimg}\PY{o}{.}\PY{n}{imread}\PY{p}{(}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{test\PYZus{}images/solidYellowCurve2.jpg}\PY{l+s+s1}{\PYZsq{}}\PY{p}{)}
         \PY{n}{solidWhiteCurveImage}\PY{o}{=}\PY{n}{mpimg}\PY{o}{.}\PY{n}{imread}\PY{p}{(}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{test\PYZus{}images/solidWhiteCurve.jpg}\PY{l+s+s1}{\PYZsq{}}\PY{p}{)}
         \PY{n}{solidYellowCurveImage}\PY{o}{=}\PY{n}{mpimg}\PY{o}{.}\PY{n}{imread}\PY{p}{(}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{test\PYZus{}images/solidYellowCurve.jpg}\PY{l+s+s1}{\PYZsq{}}\PY{p}{)}
         \PY{n}{solidWhiteRightImage}\PY{o}{=}\PY{n}{mpimg}\PY{o}{.}\PY{n}{imread}\PY{p}{(}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{test\PYZus{}images/solidWhiteRight.jpg}\PY{l+s+s1}{\PYZsq{}}\PY{p}{)}
         
         \PY{c+c1}{\PYZsh{}For the White Care Lane Switch Image }
         \PY{n}{solidWhiteRightImage}\PY{o}{=}\PY{n}{solidYellowLeftImage}
         \PY{n}{whiteCarLaneSwitchImage\PYZus{}grayScale}\PY{o}{=}\PY{n}{grayscale}\PY{p}{(}\PY{n}{solidWhiteRightImage}\PY{p}{)}
         \PY{n}{whiteCarLaneSwitchImage\PYZus{}guassianBlur}\PY{o}{=} \PY{n}{gaussian\PYZus{}blur}\PY{p}{(}\PY{n}{whiteCarLaneSwitchImage\PYZus{}grayScale}\PY{p}{,}\PY{l+m+mi}{5}\PY{p}{)}
         \PY{n}{whiteCarLaneSwitchImage\PYZus{}canny}\PY{o}{=} \PY{n}{canny}\PY{p}{(}\PY{n}{whiteCarLaneSwitchImage\PYZus{}guassianBlur}\PY{p}{,}\PY{l+m+mi}{50}\PY{p}{,}\PY{l+m+mi}{150}\PY{p}{)}
         \PY{n}{imshape}\PY{o}{=}\PY{n}{whiteCarLaneSwitchImage\PYZus{}canny}\PY{o}{.}\PY{n}{shape}
         \PY{n}{vertices} \PY{o}{=} \PY{n}{np}\PY{o}{.}\PY{n}{array}\PY{p}{(}\PY{p}{[}\PY{p}{[}\PY{p}{(}\PY{l+m+mi}{150}\PY{p}{,}\PY{n}{imshape}\PY{p}{[}\PY{l+m+mi}{0}\PY{p}{]}\PY{p}{)}\PY{p}{,}\PY{p}{(}\PY{l+m+mi}{460}\PY{p}{,} \PY{l+m+mi}{320}\PY{p}{)}\PY{p}{,} \PY{p}{(}\PY{l+m+mi}{500}\PY{p}{,} \PY{l+m+mi}{320}\PY{p}{)}\PY{p}{,} \PY{p}{(}\PY{l+m+mi}{900}\PY{p}{,}\PY{n}{imshape}\PY{p}{[}\PY{l+m+mi}{0}\PY{p}{]}\PY{p}{)}\PY{p}{]}\PY{p}{]}\PY{p}{,} \PY{n}{dtype}\PY{o}{=}\PY{n}{np}\PY{o}{.}\PY{n}{int32}\PY{p}{)}
         \PY{n}{whiteCarLaneSwitchImage\PYZus{}interest}\PY{o}{=}\PY{n}{region\PYZus{}of\PYZus{}interest}\PY{p}{(}\PY{n}{whiteCarLaneSwitchImage\PYZus{}canny}\PY{p}{,}\PY{n}{vertices}\PY{p}{)}
         \PY{n}{whiteCarLaneSwitchImage\PYZus{}hough}\PY{o}{=} \PY{n}{hough\PYZus{}lines}\PY{p}{(}\PY{n}{whiteCarLaneSwitchImage\PYZus{}interest}\PY{p}{,}\PY{l+m+mi}{1}\PY{p}{,}\PY{n}{np}\PY{o}{.}\PY{n}{pi}\PY{o}{/}\PY{l+m+mi}{180}\PY{p}{,}\PY{l+m+mi}{5}\PY{p}{,}\PY{l+m+mi}{5}\PY{p}{,}\PY{l+m+mi}{4}\PY{p}{)}
         
         \PY{c+c1}{\PYZsh{}Getting the lines }
         
         \PY{c+c1}{\PYZsh{}whiteCarLaneSwitchImage\PYZus{}Line= draw\PYZus{}lines(whiteCarLaneSwitchImage\PYZus{}hough,)}
         \PY{n}{whiteCarLaneSwitchImage\PYZus{}weighted}\PY{o}{=}\PY{n}{weighted\PYZus{}img}\PY{p}{(}\PY{n}{whiteCarLaneSwitchImage\PYZus{}hough}\PY{p}{,}\PY{n}{solidWhiteRightImage}\PY{p}{)}
         \PY{c+c1}{\PYZsh{}plt.imshow(whiteCarLaneSwitchImage\PYZus{}weighted)}
\end{Verbatim}
...
forum post} for more troubleshooting tips across operating systems.}
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}35}]:} \PY{c+c1}{\PYZsh{} Import everything needed to edit/save/watch video clips}
...
\end{Verbatim}
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}36}]:} \PY{k}{def} \PY{n+nf}{process\PYZus{}image}\PY{p}{(}\PY{n}{image}\PY{p}{)}\PY{p}{:}
             ...
             \PY{c+c1}{\PYZsh{}For the White Care Lane Switch Image }
             \PY{n}{whiteCarLaneSwitchImage\PYZus{}grayScale}\PY{o}{=}\PY{n}{grayscale}\PY{p}{(}\PY{n}{image}\PY{p}{)}
             \PY{n}{whiteCarLaneSwitchImage\PYZus{}guassianBlur}\PY{o}{=} \PY{n}{gaussian\PYZus{}blur}\PY{p}{(}\PY{n}{whiteCarLaneSwitchImage\PYZus{}grayScale}\PY{p}{,}\PY{l+m+mi}{5}\PY{p}{)}
             \PY{n}{whiteCarLaneSwitchImage\PYZus{}canny}\PY{o}{=} \PY{n}{canny}\PY{p}{(}\PY{n}{whiteCarLaneSwitchImage\PYZus{}guassianBlur}\PY{p}{,}\PY{l+m+mi}{50}\PY{p}{,}\PY{l+m+mi}{150}\PY{p}{)}
             \PY{n}{imshape}\PY{o}{=}\PY{n}{whiteCarLaneSwitchImage\PYZus{}canny}\PY{o}{.}\PY{n}{shape}
             \PY{n}{vertices} \PY{o}{=} \PY{n}{np}\PY{o}{.}\PY{n}{array}\PY{p}{(}\PY{p}{[}\PY{p}{[}\PY{p}{(}\PY{l+m+mi}{150}\PY{p}{,}\PY{n}{imshape}\PY{p}{[}\PY{l+m+mi}{0}\PY{p}{]}\PY{p}{)}\PY{p}{,}\PY{p}{(}\PY{l+m+mi}{460}\PY{p}{,} \PY{l+m+mi}{320}\PY{p}{)}\PY{p}{,} \PY{p}{(}\PY{l+m+mi}{500}\PY{p}{,} \PY{l+m+mi}{320}\PY{p}{)}\PY{p}{,} \PY{p}{(}\PY{l+m+mi}{900}\PY{p}{,}\PY{n}{imshape}\PY{p}{[}\PY{l+m+mi}{0}\PY{p}{]}\PY{p}{)}\PY{p}{]}\PY{p}{]}\PY{p}{,} \PY{n}{dtype}\PY{o}{=}\PY{n}{np}\PY{o}{.}\PY{n}{int32}\PY{p}{)}
         ...
         \PY{c+c1}{\PYZsh{}whiteCarLaneSwitchImage\PYZus{}Line= draw\PYZus{}lines(whiteCarLaneSwitchImage\PYZus{}hough,)}
             \PY{n}{result}\PY{o}{=}\PY{n}{weighted\PYZus{}img}\PY{p}{(}\PY{n}{whiteCarLaneSwitchImage\PYZus{}hough}\PY{p}{,}\PY{n}{solidWhiteRightImage}\PY{p}{)}
...
\end{Verbatim}
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}37}]:} \PY{n}{video\PYZus{}path} \PY{o}{=} \PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{/home/yomna/Downloads/solidWhiteRight.mp4}\PY{l+s+s1}{\PYZsq{}}
         
         \PY{n}{HTML}\PY{p}{(}\PY{l+s+s2}{\PYZdq{}\PYZdq{}\PYZdq{}}
         \PY{l+s+s2}{\PYZlt{}video width=}\PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{840}\PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{ height=}\PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{460}\PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{ controls=}\PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{\PYZgt{}}
         ...
         \PY{l+s+s2}{\PYZdq{}\PYZdq{}\PYZdq{}}\PY{o}{.}\PY{n}{format}\PY{p}{(}\PY{n}{video\PYZus{}path}\PY{p}{)}\PY{p}{)}
         ...
         \PY{n}{white\PYZus{}output} \PY{o}{=} \PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{test\PYZus{}videos\PYZus{}output/solidWhiteRight.mp4}\PY{l+s+s1}{\PYZsq{}}
...
[MoviePy] Writing video test\_videos\_output/solidWhiteRight.mp4
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
100\%|█████████▉| 221/222 [00:07<00:00, 28.60it/s]
...
CPU times: user 2.09 s, sys: 194 ms, total: 2.28 s
Wall time: 8.41 s
...
player of choice.
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}38}]:} \PY{n}{HTML}\PY{p}{(}\PY{l+s+s2}{\PYZdq{}\PYZdq{}\PYZdq{}}
...
tricky!
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}39}]:} \PY{n}{yellow\PYZus{}output} \PY{o}{=} \PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{test\PYZus{}videos\PYZus{}output/solidYellowLeft.mp4}\PY{l+s+s1}{\PYZsq{}}
         \PY{c+c1}{\PYZsh{}\PYZsh{} To speed up the testing process you may want to try your pipeline on a shorter subclip of the video}
         \PY{c+c1}{\PYZsh{}\PYZsh{} To do so add .subclip(start\PYZus{}second,end\PYZus{}second) to the end of the line below}
         \PY{c+c1}{\PYZsh{}\PYZsh{} Where start\PYZus{}second and end\PYZus{}second are integer values representing the start and end of the subclip}
         \PY{c+c1}{\PYZsh{}\PYZsh{} You may also uncomment the following line for a subclip of the first 5 seconds}
...
[MoviePy] Writing video test\_videos\_output/solidYellowLeft.mp4
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
100\%|█████████▉| 681/682 [00:24<00:00, 27.76it/s]
...
CPU times: user 6.27 s, sys: 652 ms, total: 6.92 s
Wall time: 25.2 s
...
it along with the rest of your project!
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}41}]:} \PY{n}{challenge\PYZus{}output} \PY{o}{=} \PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{test\PYZus{}videos\PYZus{}output/challenge.mp4}\PY{l+s+s1}{\PYZsq{}}
         \PY{c+c1}{\PYZsh{}\PYZsh{} To speed up the testing process you may want to try your pipeline on a shorter subclip of the video}
         \PY{c+c1}{\PYZsh{}\PYZsh{} To do so add .subclip(start\PYZus{}second,end\PYZus{}second) to the end of the line below}
         \PY{c+c1}{\PYZsh{}\PYZsh{} Where start\PYZus{}second and end\PYZus{}second are integer values representing the start and end of the subclip}
         \PY{c+c1}{\PYZsh{}\PYZsh{} You may also uncomment the following line for a subclip of the first 5 seconds}
...
\end{Verbatim}
    ...
    ---> 89         return f(*new\_a, **new\_kw)
        ...
        /opt/conda/lib/python3.6/site-packages/moviepy/Clip.py in get\_frame(self, t)
         93                 return frame
         94         else:
    ---> 95             return self.make\_frame(t)
         96 
         97     def fl(self, fun, apply\_to=[], keep\_duration=True):


        /opt/conda/lib/python3.6/site-packages/moviepy/Clip.py in <lambda>(t)
        134 
        135         \#mf = copy(self.make\_frame)
    --> 136         newclip = self.set\_make\_frame(lambda t: fun(self.get\_frame, t))
        137 
        ...
        /opt/conda/lib/python3.6/site-packages/moviepy/video/VideoClip.py in <lambda>(gf, t)
        531         `get\_frame(t)` by another frame,  `image\_func(get\_frame(t))`
        532         """
    --> 533         return self.fl(lambda gf, t: image\_func(gf(t)), apply\_to)
        534 
        ...
        <ipython-input-36-64c7d711d1fd> in process\_image(image)
         14 
         15 \#whiteCarLaneSwitchImage\_Line= draw\_lines(whiteCarLaneSwitchImage\_hough,)
    ---> 16     result=weighted\_img(whiteCarLaneSwitchImage\_hough,solidWhiteRightImage)
         17     \# you should return the final output (image where lines are drawn on lanes)
         18 


        <ipython-input-32-e61fa370743b> in weighted\_img(img, initial\_img, α, β, γ)
        141     NOTE: initial\_img and img must be the same shape!
        142     """
    --> 143     return cv2.addWeighted(initial\_img, α, img, β, γ)
    

        error: /feedstock\_root/build\_artefacts/opencv\_1496434080029/work/opencv-3.2.0/modules/core/src/arithm.cpp:659: error: (-209) The operation is neither 'array op array' (where arrays have the same size and the same number of channels), nor 'array op scalar', nor 'scalar op array' in function arithm\_op
